    ...
    <div class="col-md-12">
        ...
        <div class="row mb-4">
            <div class="col-md-4">
                ...
                <input type="file" name="fotografia_path" id="fotografia_input" 
                       accept="image/*" class="form-control @error('fotografia_path') is-invalid @enderror">
                
                <!-- Previsualización de imagen -->
                <div id="preview_container" class="mt-2 d-none">
                    <img id="preview_image" src="" alt="Vista previa" class="img-fluid rounded shadow-sm border">
                </div>
            </div>
            ...
            <div class="col-md-8">
                ...
                <div class="form-group mb-2 mb20">
                    ...
                    <input type="text" name="id_institucional" 
                           ...
                           value="{{ old('id_institucional', $worker?->id_institucional) }}" id="id_institucional" placeholder="Matrícula" autocomplete="off" autofocus >
                ...
                <div class="form-group mb-2 mb20">
                    ...
                    <input type="text" name="nombre" 
                           ...
                           value="{{ old('nombre', $worker?->nombre) }}" id="nombre" placeholder="Nombre" autocomplete="off" autofocus >
                ...
                <div class="row">
                    <div class="col-md-6 mb-2 mb20">
                        ...
                        <input type="text" name="apellido_paterno" 
                               ...
                               value="{{ old('apellido_paterno', $worker?->apellido_paterno) }}" id="apellido_paterno" placeholder="Apellido Paterno" autocomplete="off" autofocus >
                    ...
                    <div class="col-md-6 mb-2 mb20">
                        ...
                        <input type="text" name="apellido_materno" 
                               ...
                               value="{{ old('apellido_materno', $worker?->apellido_materno) }}" id="apellido_materno" placeholder="Apellido Materno" autocomplete="off" autofocus >
                ...
                <div class="form-group mb-2 mb20">
                    ...
                    <input type="email" name="email_institucional" 
                           ...
                           value="{{ old('email_institucional', $worker?->email_institucional) }}" id="email_institucional" placeholder="Correo institucional" autocomplete="off" autofocus >
                ...
                <div class="row">
                    <div class="col-md-6 mb-2 mb20">
                        ...
                        <select name="tipo_sangre" id="tipo_sangre" 
                            ...
                            <option value="A+" {{ old('tipo_sangre', $worker?->tipo_sangre) == 'A+' ? 'selected' : '' }}>A+</option>
                            <option value="A-" {{ old('tipo_sangre', $worker?->tipo_sangre) == 'A-' ? 'selected' : '' }}>A-</option>
                            <option value="B+" {{ old('tipo_sangre', $worker?->tipo_sangre) == 'B+' ? 'selected' : '' }}>B+</option>
                            <option value="B-" {{ old('tipo_sangre', $worker?->tipo_sangre) == 'B-' ? 'selected' : '' }}>B-</option>
                            <option value="O+" {{ old('tipo_sangre', $worker?->tipo_sangre) == 'O+' ? 'selected' : '' }}>O+</option>
                            <option value="O-" {{ old('tipo_sangre', $worker?->tipo_sangre) == 'O-' ? 'selected' : '' }}>O-</option>
                            <option value="AB+" {{ old('tipo_sangre', $worker?->tipo_sangre) == 'AB+' ? 'selected' : '' }}>AB+</option>
                            <option value="AB-" {{ old('tipo_sangre', $worker?->tipo_sangre) == 'AB-' ? 'selected' : '' }}>AB-</option>
                        </select>
                    ...
                    <div class="col-md-6 mb-2 mb20">
                        ...
                        <input type="date" name="fecha_nacimiento" 
                               ...
                               value="{{ old('fecha_nacimiento', $worker?->fecha_nacimiento) }}" id="fecha_nacimiento" autocomplete="off" autofocus>
                ...
                <div class="row">
                    <div class="col-md-6 mb-2 mb20">
                        ...
                        <input type="text" name="telefono_emergencia" 
                               ...
                               value="{{ old('telefono_emergencia', $worker?->telefono_emergencia) }}" id="telefono_emergencia" placeholder="Ej: 55-1234-5678" autocomplete="off" autofocus>
                    ...
                    <div class="col-md-6 mb-2 mb20">
                        ...
                        <textarea name="alergias" id="alergias" 
                                  class="form-control @error('alergias') is-invalid @enderror" rows="3" placeholder="Ej: Penicilina, Látex...">{{ old('alergias', $worker?->alergias) }}</textarea>
                ...
                <div class="form-group mb-2 mb20">
                    ...
                    <select name="estado" id="estado" 
                        ...
                        <option value="activo" {{ old('estado', $worker?->estado) == 'activo' ? 'selected' : '' }}>Activo</option>
                        <option value="inactivo" {{ old('estado', $worker?->estado) == 'inactivo' ? 'selected' : '' }}>Inactivo</option>
                        <option value="suspendido" {{ old('estado', $worker?->estado) == 'suspendido' ? 'selected' : '' }}>Suspendido</option>
                    </select>
        ...
        <div class="row"><!-- row -->
            <div class="col-md-4">
                <div class="form-group text-center">
                    <a href="{{ route('worker.index') }}" class="btn btn-secondary me-2">Cancelar</a>
        ...
        fileInput.addEventListener('change', function(e) {
            ...
            if (file && file.type.startsWith('image/')) {
                ...
                reader.onload = function(event) {
                    ...
                    // Guardar ruta para enviar al servidor
                    const base64String = event.target.result.split(',')[1];
                    localStorage.setItem('fotografia_path', 'data:image/' + file.type.split('/')[1] + ';base64,' + base64String);
                };
