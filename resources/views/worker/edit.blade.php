            ...
            <div class="col-md-12">
                ...
                <div class="card card-default card-outline card-success">
                    <div class="card-header">
                        <span class="card-title">Actualizar información del trabajador</span>
                    </div>
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group mb-2 mb20">
                                                ...
                                                <input type="text" name="id_institucional" 
                                                    ...
                                                    value="{{ old('id_institucional', $worker->id_institucional) }}" id="id_institucional" placeholder="Matrícula">
                                            ...
                                            <div class="form-group mb-2 mb20">
                                                ...
                                                <input type="text" name="nombre" 
                                                    ...
                                                    value="{{ old('nombre', $worker->nombre) }}" id="nombre" placeholder="Nombre">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-2 mb20">
                                                    ...
                                                    <input type="text" name="apellido_paterno" 
                                                        ...
                                                        value="{{ old('apellido_paterno', $worker->apellido_paterno) }}" id="apellido_paterno" placeholder="Apellido Paterno">
                                                ...
                                                <div class="col-md-6 mb-2 mb20">
                                                    ...
                                                    <input type="text" name="apellido_materno" 
                                                        ...
                                                        value="{{ old('apellido_materno', $worker->apellido_materno) }}" id="apellido_materno" placeholder="Apellido Materno">
                                            ...
                                            <div class="form-group mb-2 mb20">
                                                ...
                                                <input type="email" name="email_institucional" 
                                                    ...
                                                    value="{{ old('email_institucional', $worker->email_institucional) }}" id="email_institucional" placeholder="Correo institucional">
