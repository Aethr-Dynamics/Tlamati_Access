<aside class="app-sidebar shadow" style="background-color: #ECEFF1;"><!--begin::Sidebar-->
    ...
    <div class="sidebar-brand"><!--begin::Sidebar Brand-->
        <a href="{{url('/')}}" class="brand-link"><!--begin::Brand Link-->
        ...
        >
            ...
            <li class="nav-item"><!-- begin::Options Menu -->
                <a href="{{url('/')}}" class="nav-link">
                    <i class="nav-icon bi bi-palette" style="color: rgb(38, 166, 154);"></i>
                    <p>Principal</p>
                </a>
            </li><!-- end::Options Menu -->
            ...
            <li class="nav-item"><!-- begin::Options Menu -->
                <a href="{{url('buscar')}}" class="nav-link">
                    <i class="fa-solid fa-magnifying-glass" style="color: rgb(38, 166, 154);"></i>
                    <p>Escaner</p>
                </a>
            </li><!-- end::Options Menu -->
            ...
            <li class="nav-item"><!-- begin::Options Menu -->
                <a href="#" class="nav-link">
                    <i class="fa-solid fa-school-circle-exclamation" style="color: rgb(38, 166, 154);"></i>
            ...
            <li class="nav-item"><!-- begin::Options Menu -->
                <a href="#" class="nav-link">
                    <i class="fa-solid fa-school" style="color: rgb(38, 166, 154);"></i>
            ...
            <li class="nav-item"><!-- begin::Options Menu -->
                <a href="#" class="nav-link">
                    <i class="fa-solid fa-address-card" style="color: rgb(38, 166, 154);"></i>
            ...
            <li class="nav-item"><!-- begin::Options Menu -->
                <a href="#" class="nav-link">
                    <i class="fa-solid fa-person-chalkboard" style="color: rgb(38, 166, 154);"></i>
            ...
            <li class="nav-item"><!-- begin::Options Menu -->
                <a href="#" class="nav-link">
                    <i class="fa-solid fa-user-graduate" style="color: rgb(38, 166, 154);"></i>
            ...
            <li class="nav-item"><!-- begin::Options Menu -->
                <a href="#" class="nav-link">
                    <i class="fa-solid fa-person-military-to-person" style="color: rgb(38, 166, 154);"></i>
            ...
            <li class="nav-item"><!-- begin::Options Menu -->
                <a href="#" class="nav-link">
                    <i class="fa-solid fa-person-arrow-down-to-line" style="color: rgb(38, 166, 154);"></i>
            ...
            <!-- ---------- CODE_QR ---------- -->
            <li class="nav-header">Códigos QR</li>
            <li class="nav-item"><!-- begin::Options Menu -->
                <a href="#" class="nav-link">
                    <i class="fa-solid fa-person-arrow-down-to-line" style="color: rgb(38, 166, 154);"></i>
                    <p>Codigos <i class="nav-arrow bi bi-chevron-right"></i> </p>
                </a>
                
                <ul class="nav nav-treeview"><!-- begin::Opciones para el sub-menu -->
                    <!-- Opcion de sub-menu -->
                    <li class="nav-item">
                        <a href="{{url('codeqr/create')}}" class="nav-link">
                            <i class="fa-solid fa-caret-right" style="color: #FFB74D;"></i>
                            <p>Nuevo QR</p>
                        </a>
                    </li>
