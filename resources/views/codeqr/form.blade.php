<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            <label for="codeqr" class="form-label">{{ __('Codeqr') }}</label>
            <input type="text" name="codeqr" class="form-control @error('codeqr') is-invalid @enderror" value="{{ old('codeqr', $codeqr?->codeqr) }}" id="codeqr" placeholder="Codeqr">
            {!! $errors->first('codeqr', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
