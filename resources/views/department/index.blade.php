    ...
    <div class="app-content-header"><!--begin::App Content Header-->
        <div class="container-fluid"><!--begin::Container-->
            <div class="row"><!--begin::Row-->
                <div class="col-sm-6">
                    <h3 class="mb-0">Lasta de departamentos</h3>
                </div>
            </div><!--end::Row-->
        </div><!--end::Container-->
                            ...
                            <span id="card_title">
                             ...
                             <div class="float-right">
                                <a href="{{ route('department.create') }}" class="btn btn-primary btn-sm float-right"  data-placement="left">
                                    <i class="fa-solid fa-school" style="color: #E0E0E0"></i> Nuevo departamento
                                </a>
                              </div>
                        </div>
                    </div>
										...
										<td >{{ $department->nombre }}</td>
                                            ...
                                            <td>    
                                                <form action="{{ route('department.destroy', $department->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('department.show', $department->id) }}">
                                                        <i class="fa fa-fw fa-eye" style="color: #E0E0E0;"></i> {{ __('Show') }}
                                                    </a>

                                                    <a class="btn btn-sm btn-success" href="{{ route('department.edit', $department->id) }}">
