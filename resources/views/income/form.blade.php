<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="number" name="id_student" class="form-control @error('id_student') is-invalid @enderror" value="{{ old('id_student', $income?->id_student) }}" id="id_student" placeholder="Id Student">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="number" name="id_worker" class="form-control @error('id_worker') is-invalid @enderror" value="{{ old('id_worker', $income?->id_worker) }}" id="id_worker" placeholder="Id Worker">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="number" name="id_visitor" class="form-control @error('id_visitor') is-invalid @enderror" value="{{ old('id_visitor', $income?->id_visitor) }}" id="id_visitor" placeholder="Id Visitor">
