            ...
            <div class="col-md-8">
                ...
                <div class="form-group mb-2 mb20">
                    ...
                    <input type="text" name="id_institucional" 
                           ...
                           value="{{ old('id_institucional', $student?->id_institucional) }}" id="id_institucional" placeholder="Matrícula" autocomplete="off">
                ...
                <div class="form-group mb-2 mb20">
                    ...
                    <input type="text" name="nombre" 
                           ...
                           value="{{ old('nombre', $student?->nombre) }}" id="nombre" placeholder="Nombre" autocomplete="off">
                ...
                <div class="row">
                    <div class="col-md-6 mb-2 mb20">
                        ...
                        <input type="text" name="apellido_paterno" 
                               ...
                               value="{{ old('apellido_paterno', $student?->apellido_paterno) }}" id="apellido_paterno" placeholder="Apellido Paterno" autocomplete="off">
                    ...
                    <div class="col-md-6 mb-2 mb20">
                        ...
                        <input type="text" name="apellido_materno" 
                               ...
                               value="{{ old('apellido_materno', $student?->apellido_materno) }}" id="apellido_materno" placeholder="Apellido Materno" autocomplete="off">
                ...
                <div class="form-group mb-2 mb20">
                    ...
                    <input type="email" name="email_institucional" 
                           ...
                           value="{{ old('email_institucional', $student?->email_institucional) }}" id="email_institucional" placeholder="Correo institucional" autocomplete="off">
