...
class Worker extends Model
{
     ...
     */
    protected $fillable = ['id_worker', 'nombre', 'apellido_materno', 'apellido_paterno', 'id_school', 'id_rol', 'id_offer', 'estado', 'fotografia', 'code_qr'];
    ...
    {
        return $this->hasMany(\App\Models\Income::class, 'id_worker', 'id_worker');
    }
