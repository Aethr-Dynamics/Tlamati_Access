...
class Student extends Model
{
     ...
     */
    protected $fillable = ['nombre', 'apellido_materno', 'apellido_paterno', 'id_school', 'id_rol', 'id_offer', 'estado', 'fecha_nacimiento', 'fotografia'];
    ...
    {
        return $this->hasMany(\App\Models\Income::class, 'id', 'id_student');
    }
